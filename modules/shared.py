...
class Options:
    ...
    data_labels = {
        ...
        "show_progress_every_n_steps": OptionInfo(5, "Show show image creation progress every N sampling steps. Set 0 to disable.", gr.Slider, {"minimum": 0, "maximum": 32, "step": 1}),
